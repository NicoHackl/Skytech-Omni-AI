...
> [frontend.md](frontend.md), der Inhalt der Texte in [nutzertexte.md](nutzertexte.md) — beides
> wird hier nicht wiederholt. Hier steht nur das Aussehen: Tokens, Klassen, Zustände.
...
`--mono` nur für technische Werte: IDs, JSON, Dateinamen, Farbcodes. Dass es eine Schriftart dafür
gibt, ist **keine Erlaubnis, solche Werte anzuzeigen** — sie erscheinen nur dort, wo der Nutzer sie
wirklich braucht (eiserne Regel 12, [nutzertexte.md](nutzertexte.md)).
